...
<?php echo $add_room_button ?>
    ...
    <div style="text-align: left; padding-top: 20px;">
        ...
        <svg width="1000" height="400" style="float: bottom;position:absolute;">
            ...
            <rect id="pokoj204" x="560" y="230" width="30" height="60" onmouseover="roomHoverIn(id,'204')" onmouseout="roomHoverOut(id)" style="fill:transparent;stroke-width:1;stroke:rgb(0,0,0);"/>
            <rect id="pokoj211" x="197" y="225" width="30" height="65" onmouseover="roomHoverIn(id,'211')" onmouseout="roomHoverOut(id)" style="fill:transparent;stroke-width:1;stroke:rgb(0,0,0);"/>
            <rect id="pokoj212" x="160" y="225" width="35" height="65" onmouseover="roomHoverIn(id,'212')" onmouseout="roomHoverOut(id)" style="fill:transparent;stroke-width:1;stroke:rgb(0,0,0);"/>
            <rect id="pokoj213" x="135" y="225" width="25" height="65" onmouseover="roomHoverIn(id,'213')" onmouseout="roomHoverOut(id)" style="fill:transparent;stroke-width:1;stroke:rgb(0,0,0);"/>
            
            <img src="wi1-2-pietro2.png" width="1000" height="400" >
        </svg>
